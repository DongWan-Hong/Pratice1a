...
private:
    ...
    void OnPaint()
    {
        ...
        BitBlt(
            ...
            0,
            0,
            bitmap.bmWidth, // 비트맵 원본 크기
            bitmap.bmHeight,// 비트맵 원본 크기   
            memDC,          // 원본 DC
            0,              // 원본 시작 위치
            0,              // 원본 시작 위치
            SRCCOPY
    ...
    )
    {
        ...
        if (message == WM_NCCREATE)
        {
            ...
            window =
                static_cast<BitmapWindow*>(createStruct->lpCreateParams);
        ...
        else
        {
            ...
            window =
            reinterpret_cast<BitmapWindow*>(GetWindowLongPtr(
                        hWnd,
                        GWLP_USERDATA));
        }
